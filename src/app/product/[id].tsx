	...
	return (
		<View className="flex-1">
			...
			<View className="p-5 mt-8 flex-1">
				<Text className="text-lime-400 text-3xl font-heading my-2">{product.title}</Text>
				<Text className="text-white text-2xl font-heading my-2">{formatCurrency(product.price)}</Text>
